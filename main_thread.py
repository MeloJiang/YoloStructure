import argparse
from yolov7.utils.envs import get_envs
from yolov7.utils.config import Config
from yolov7.core.egine import Trainer
...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--eval-interval', default=6, type=int, help='evaluate at every interval epochs')
    ...
    parser.add_argument('--save_dir', type=str, default='./train_saved_models', help='path to save trained models')
    return parser
...
if __name__ == '__main__':
    ...
    trainer = Trainer(args, cfg, device='cuda')
    trainer.train()
